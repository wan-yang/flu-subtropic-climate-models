...
# calculate R0
calc_R0_AH_T <- function(in.parms, num.ens, sh1, mean.temp) {
...
num_ens=dim(parms)[1]
R0 <- calc_R0_AH_T(parms, num_ens, sh1.daily, mean.temp.daily)[[2]]
...
# SIRS model
SIRS_AH_T <- function(tm_strt, tm_end, tm_step, S0, I0, N, D, L, beta, expoI, realdata=FALSE){
...
sim_AH_T <- SIRS_AH_T(tm_strt, tm_end, tm_step, S0, I0, N, D, L, beta, expoI, realdata=T)
